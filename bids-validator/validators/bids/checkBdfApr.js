...
if (bdfNotInAprFiles[0]!=="" && aprNotInBdfFiles[0]!==""){ 
  const evidence = "Given that there were bdf/bdf.gz files of the same name, the following files were expected, but not found in the dataset:\n                                  " 
...
const evidence = "Given that there were .apr files of the same name, the following files were expected, but not found in the dataset:\n                                  " 
    + bdfNotInAprFiles.join('.bdf(.gz) \n                                  ')
return evidence
